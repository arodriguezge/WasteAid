        ...
        return (
            <React.Fragment>
                ...
                <ul>
                    ...
                    <li>Incinerating rubbish in power stations is a waste of valuable raw materials and should only be done with non-recycable refuse.<br/></li>
                    <li>Exporting rubbish into other countries, especially into developing countries, <br/>
                    is a comfortable way of getting rid of it, but apropriate, environmental-friendly disposal or recycling there is doubtful.<br/></li>
               ...
               <h4 className="display-5 ml-5 pt-4 mb-5 mt-4">Learn more</h4>
                <div className="container">
                    <a
                    href="https://allaboutberlin.com/guides/sorting-trash-in-germany" target="_blank"> https://allaboutberlin.com/guides/sorting-trash-in-germany</a>
                    
                    <br />
                    <a href="https://www.aliadventures.com/2013/02/how-to-throw-out-your-garbage-in-germany/" target="_blank">https://www.aliadventures.com/2013/02/how-to-throw-out-your-garbage-in-germany/</a>
                    <br />
