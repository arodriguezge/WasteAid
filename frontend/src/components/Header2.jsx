                ...
                <Navbar bg="success" expand="lg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                        <Nav className="mr-auto">
                            <Nav.Link className="nav-text text-grey" href="/" exact activeClassName="active"><span className="pb-1">Home</span></Nav.Link>
                            <Nav.Link className="nav-text text-grey" href="/searchArea"><span className="pb-1">Search Area</span></Nav.Link>
                            <Nav.Link className="nav-text text-grey" href="/mapSearch"><span className="pb-1">Map Search</span></Nav.Link>
                            <Nav.Link className="nav-text text-grey" href="/add">Add an Item</Nav.Link>
