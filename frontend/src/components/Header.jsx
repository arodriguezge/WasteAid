                ...
                <Navbar bg="success" expand="lg">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                        ...
                        <Nav className="">
                            ...
                            <Nav.Link className="nav-text text-grey" href="/searchArea" activeclassname="active"><span className="pb-1 hover">Search Area</span></Nav.Link>
                            <Nav.Link className="nav-text text-grey" href="/mapSearch" activeclassname="active"><span className="pb-1 hover">Map Search</span></Nav.Link>
