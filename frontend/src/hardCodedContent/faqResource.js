// key "answers": line breaks between strings or even a paragraph for each string
...
export const faq = [
    ...
    {
        question: "What happens to all the garbage after the pick-up?",
        answers: [
            "RECYCLING of litter is the most sustainable and environment-friendly way of treating rubbish and should be preferred. This requires the consumers support as they need to sort their refuse and dispose of it separately.",
            "BURYING litter in landfills is a waste of land and fosters the climate change by releasing methane with is a potent greenhouse gas.",
            "INCINERATING rubbish in power stations is a waste of valuable raw materials and should only be done with non-recycable refuse.",
            "EXPORTING rubbish into other countries, especially into developing countries, is a comfortable way of getting rid of it, but appropriate, environmental-friendly disposal or recycling there is doubtful."
        ],
        links: []
    },
    {
        question: "Are there any USEFUL LINKS to learn more about the topic?",
        answers: [],
        links: ["https://allaboutberlin.com/guides/sorting-trash-in-germany",
            "https://www.aliadventures.com/2013/02/how-to-throw-out-your-garbage-in-germany/",
            "https://www.infomigrants.net/en/post/5817/step-by-step-how-to-recycle-in-germany"
        ]
    },
    {
    ...
    {
        question: "Can I put all of the papers and cardboards into the scrap paper container?",
        answers: [
            "No. Paper or cardboard that has been contaminated with food, fat, oil, excretions etc. belongs to the residual waste. They are not suitable for recycling."
        ],
        links: []
    },
    {
        question: "Do hygiene products made of cotton (cellulose) belong to waste paper or to biowaste?",
        answers: [
            "None of them. They are residual waste because usually dirty and not easily compostable."
        ],
        links: []
    },
    {
