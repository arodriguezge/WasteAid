export const binDescriptions = {
    blue: {
        ...
        hints: "Please, remove any attached plastic parts like adhesive tape if possible! Books can be donated instead of throwing them away. Tear cardboard boxes apart to reduce volume."
    },
    green: {
        ...
        hints: "Please, empty the bottles and jars before disposal! Removal of caps and lids is good but not a must. Some public glass container are only for brown or green glass."
    },
    white: {
        ...
        hints: "Please, empty the bottles and jars before disposal! Removal of caps and lids is good but not a must."
    },
    yellow: {
        germanName: "WERTSTOFFE",
        allowed: "PLASTIC, METAL, GREEN DOT (bottles, foil, tin cans, tooth brushes, yogurt pots)",
        forbidden: "Rubber, electronics, data storage devices (CD, DVD). Nonferrous metals except aluminium.",
        hints: "Please, empty the bottles and jars before disposal! Return returnable bottles and beer cans to the vendor to get some money back!"
    },
    brown: {
        germanName: "BIOGUT",
